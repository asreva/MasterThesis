...
def compute_metrics(predicition_list, target_list, name_extension):
    """ 
        ...
        Parameters:
            ...
            - name_extension: extension to add to the metric name in the dictionnary (i.e. to indicate that it is the validation metric)
    ...
    try: # The AUC computations may fail if a class is not present in one of the vectors -> consider 0 in this case
