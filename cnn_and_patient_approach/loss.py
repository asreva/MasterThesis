...
# --- Functions --- #
def compute_full_loss(pred, lad_pred, lcx_pred, rca_pred, x_lad_pair, x_lcx_pair, x_rca_pair, patient_data_pred, target, criterion, train_configruation):
    """ 
        ...
        Parameters:
            ...
            - train_configruation: configruation of the training, includes the ratio of the losses
        
        Output: the MI loss, the MI loss at artery level, the siamese loss, the patient data loss
    """
    ...
    # Patient pred loss
    loss_patient = criterion(patient_data_pred, patient_mi)*train_configruation["pred_from_patient_data_loss_ratio"]
    ...
    return loss_crit, (loss_arteries_lad, loss_arteries_lcx, loss_arteries_rca) , (loss_siam_lad, loss_siam_lcx, loss_siam_rca), loss_patient