"""
Aim: Implement the datasetloader for the MI prediction from artery images for CNN
...
PATH_TO_DATA = 'data/train_valid_data'
PATH_TO_DATA_OVERSAMPLED = 'data/train_valid_data_oversampled'
...
def get_data_loaders(train_configuration, cv_split):
    ...
    valid_data_loader = Loader(ffcv_path,
                batch_size=train_configuration["batch_size"],
                num_workers=os.cpu_count(),
                order=OrderOption.QUASI_RANDOM,
                pipelines={
