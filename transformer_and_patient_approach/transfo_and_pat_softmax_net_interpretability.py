...
class ArteryLevelDNN_PatientData(nn.Module):
    ...
    def __init__(self, two_neur_out, patient_features, train_configuration, in_channels=1, num_levels=4, f_maps=16, dim_hidden=3456, num_heads=3, dim_head=18,
                 num_encoders=8, num_linear=2, num_class=2, num_regions=4, verbose=False):
        super().__init__()
